...
class FXITomoFlyer(Device):
    ...
    def __init__(self, dets, zebra, *, reg=db.reg, scn_mode=0, **kwargs):
        ...
        FXITomoFlyer.set_wait(self._encoder.pc.block_state_reset, 1)

        ############### Zebra Setup ###############
        ## PC Tab
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_enc1_bool, 1)
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_enc2_bool, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_enc3_bool, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_enc4_bool, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_filt1_bool, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_filt2_bool, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_div1_bool, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_div2_bool, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_div3_bool, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.data.cap_div4_bool, 0)

        FXITomoFlyer.set_wait(self._encoder.pc.enc, 0)  # 0: Enc1, 1: Enc2, 2: Enc3, 3: Enc4,
        FXITomoFlyer.set_wait(self._encoder.pc.dir, 0)  # 0: Positive, 1: Negative
        FXITomoFlyer.set_wait(self._encoder.pc.tspre, 1)  # 0: ms, 1: s, 2: 10s

        ## AND tab -- can be used for external triggering
        FXITomoFlyer.set_wait(self._encoder.and1.use1, 0)  # 0: No, 1: Yes
        FXITomoFlyer.set_wait(self._encoder.and1.use2, 0)
        FXITomoFlyer.set_wait(self._encoder.and1.use3, 0)
        FXITomoFlyer.set_wait(self._encoder.and1.use4, 0)
        FXITomoFlyer.set_wait(self._encoder.and1.input_source1, 0)
        FXITomoFlyer.set_wait(self._encoder.and1.input_source2, 0)
        FXITomoFlyer.set_wait(self._encoder.and1.input_source3, 0)
        FXITomoFlyer.set_wait(self._encoder.and1.input_source4, 0)
        FXITomoFlyer.set_wait(self._encoder.and1.invert1, 0)  # 0: No, 1: Yes
        FXITomoFlyer.set_wait(self._encoder.and1.invert2, 0)
        FXITomoFlyer.set_wait(self._encoder.and1.invert3, 0)
        FXITomoFlyer.set_wait(self._encoder.and1.invert4, 0)

        ## OR Tab -- can be used for diagnose
        FXITomoFlyer.set_wait(self._encoder.or1.use1, 0)  # 0: No, 1: Yes
        FXITomoFlyer.set_wait(self._encoder.or1.use2, 0)
        FXITomoFlyer.set_wait(self._encoder.or1.use3, 0)
        FXITomoFlyer.set_wait(self._encoder.or1.use4, 0)
        FXITomoFlyer.set_wait(self._encoder.or1.input_source1, 0)
        FXITomoFlyer.set_wait(self._encoder.or1.input_source2, 0)
        FXITomoFlyer.set_wait(self._encoder.or1.input_source3, 0)
        FXITomoFlyer.set_wait(self._encoder.or1.input_source4, 0)
        FXITomoFlyer.set_wait(self._encoder.or1.invert1, 0)  # 0 = No, 1 = Yes
        FXITomoFlyer.set_wait(self._encoder.or1.invert2, 0)
        FXITomoFlyer.set_wait(self._encoder.or1.invert3, 0)
        FXITomoFlyer.set_wait(self._encoder.or1.invert4, 0)

        ## PULSE tab -- set for fast shutter
        FXITomoFlyer.set_wait(self._encoder.pulse1.input_addr, 31)
        FXITomoFlyer.set_wait(self._encoder.pulse1.input_edge, 0)  # 0 = rising, 1 = falling
        FXITomoFlyer.set_wait(self._encoder.pulse1.delay, 0)
        FXITomoFlyer.set_wait(self._encoder.pulse2.input_addr, 31)
        FXITomoFlyer.set_wait(self._encoder.pulse2.input_edge, 1)  # 0 = rising, 1 = falling
        FXITomoFlyer.set_wait(self._encoder.pulse2.delay, 0)

        ## ENC tab
        FXITomoFlyer.set_wait(self._encoder.pc.enc_pos1_sync, 1)
        FXITomoFlyer.set_wait(self._encoder.pc.enc_pos2_sync, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.enc_pos3_sync, 0)
        FXITomoFlyer.set_wait(self._encoder.pc.enc_pos4_sync, 0)

        ## SYS tab
        FXITomoFlyer.set_wait(self._encoder.output1.ttl.addr, 53)  # PC_PULSE --> TTL1 --> Camera
        FXITomoFlyer.set_wait(self._encoder.output2.ttl.addr, 52)  # PC_PULSE --> TTL2 --> fast shutter
        FXITomoFlyer.set_wait(self._encoder.output3.ttl.addr, 0)
        FXITomoFlyer.set_wait(self._encoder.output4.ttl.addr, 0)
    ...
    def preset_zebra(self, pc_cfg={}):
        ############### PC Arm
        FXITomoFlyer.set_wait(self._encoder.pc.trig_source, 0, wait=0.01)  # 0 = Soft, 1 = External
        ############### PC Pulse
        ...
        if self.use_shutter:
            FXITomoFlyer.set_wait(self._encoder.pulse1.time_units, self.tspre)
            self._encoder.pulse1.width.put(self.dft_pulse_wid[self.tspre], timeout=10)
            ttime.sleep(0.01)
            FXITomoFlyer.set_wait(self._encoder.pulse2.time_units, self.tspre)
            self._encoder.pulse2.width.put(self.dft_pulse_wid[self.tspre], timeout=10)
            ttime.sleep(0.01)
            FXITomoFlyer.set_wait(self._encoder.output2.ttl.addr, 52)
        else:
            FXITomoFlyer.set_wait(self._encoder.output2.ttl.addr, 29)
        if self.scn_mode == "standard":
            ############### PC Tab ###############
            ## PC Gate
            FXITomoFlyer.set_wait(self._encoder.pc.gate_source, 0, wait=0.01)  # 0 = Position, 1 = Time, 2 = External
            FXITomoFlyer.set_wait(self._encoder.pc.gate_step, 0)
            FXITomoFlyer.set_wait(self._encoder.pc.gate_num, 1)

            ## PC Pulse
            FXITomoFlyer.set_wait(self._encoder.pc.pulse_source, 0, wait=0.01)  # 0 = Position, 1 = Time, 2 = External
            self._encoder.pc.pulse_width.put(self.dft_pulse_wid[self.tspre], timeout=10)
            ttime.sleep(0.01)
            ...
            ############### PC Tab ###############
            ## PC Gate
            FXITomoFlyer.set_wait(self._encoder.pc.gate_source, 2, wait=0.01)  # 0 = Position, 1 = Time, 2 = External
            FXITomoFlyer.set_wait(self._encoder.pc.gate_ext, 29)
            FXITomoFlyer.set_wait(self._encoder.pc.gate_num, 0)

            ## PC Pulse
            FXITomoFlyer.set_wait(self._encoder.pc.pulse_source, 1, wait=0.01)  # 0 = Position, 1 = Time, 2 = External
            self._encoder.pc.pulse_width.put(self.dft_pulse_wid[self.tspre], timeout=10)
            ttime.sleep(0.01)

        for key, val in pc_cfg[self.scn_mode].items():
            getattr(self._encoder.pc, key).put(val, timeout=10)
            ttime.sleep(0.01)
    ...
    def describe_collect(self):
        ...
        spec = {
            "external": ext_spec,
            "dtype": "array",
            "shape": [self.encoder.pc.data.time.get().shape[0]],
        ...
        for d in self._dets:
            ...
            for chan in d.describe().keys():
                desc[chan]['shape'] = [self.encoder.pc.data.time.get().shape[0]]
    ...
    def preset_flyer(self, scn_cfg):
        ...
        self.preset_zebra(pc_cfg)
        print("preset_flyer is done")
        return scn_cfg, pc_cfg

    def set_pc_step_for_scan(self, scn_cfg, pc_cfg):
        yield from abs_set(self.encoder.pc.dir, pc_cfg[self.scn_modes[scn_cfg["scn_mode"]]]["dir"], wait=True)
        yield from abs_set(self.encoder.pc.gate_start, pc_cfg[self.scn_modes[scn_cfg["scn_mode"]]]["gate_start"], wait=True)
    ...
    def cal_cam_rot_params(cls, det, scn_cfg):
        ...
        # det.cam.acquire_period.put(scan_cfg["acq_p"])
        # det.cam.acquire_time.put(scan_cfg["exp_t"])
        # det.cam.image_mode.put(0)  # 0: 'Fixed', 1: 'Continuous'
        # det.cam.trigger_mode.put(
        #     4
        # )  # 0: 'Internal', 1: 'External Start', 2: 'External Exposure', 3: 'Software', 4: 'External'
        ...
        if not (cls.rot_axis.low_limit_switch.get() == 0 and cls.rot_axis.high_limit_switch.get() == 0):
            if (scn_cfg["ang_s"] - taxi_dist) < cls.rot_axis.low_limit.get():
                print("Rotation range is beyond the low limit of the rotary stage. Quit!")
                return None
            elif (scn_cfg["ang_s"] - taxi_dist) > cls.rot_axis.high_limit.get():
                print("Rotation range is beyond the high limit of the rotary stage. Quit!")
                return None
        ...
        scn_cfg["num_images"] = (
            int(
                abs(
                    (scn_cfg["ang_e"] - scn_cfg["ang_s"]) / scn_cfg["vel"] / scn_cfg["acq_p"]
                )
            )
            + 1
        )
    ...
    def cal_zebra_pc_params(cls, scn_cfg):
        ...
        if cls.scn_modes[scn_cfg["scn_mode"]] == "standard":
            ...
            pc_cfg["standard"]["gate_width"] = abs(scn_cfg["ang_e"] - scn_cfg["ang_s"])
            ...
            pc_cfg["standard"]["pulse_max"] = int(round(
            ...
            pc_cfg["snaked: multiple files"]["pulse_step"] = round(scn_cfg["ang_step"], 3)
            pc_cfg["snaked: multiple files"]["pulse_max"] = int(round(
                abs(scn_cfg["ang_e"] - scn_cfg["ang_s"])
            ...
            pc_cfg["snaked: single file"]["pulse_max"] = int(int(round(
                abs(scn_cfg["ang_e"] - scn_cfg["ang_s"])
            ...
            return None
        pc_cfg[cls.scn_modes[scn_cfg["scn_mode"]]]["dir"] = cls.pc_trig_dir[scn_cfg["rot_dir"]]
        return pc_cfg
    ...
    def init_mot_r(scn_cfg):
        ...
        # if abs(ini_r - cur_pos) > 360:
        #     cur_pos = ini_r // 360 * 360 + ini_r % 360
        #     yield from abs_set(zps.pi_r.motor_calib, 1, wait=True)
        #     yield from abs_set(zps.pi_r.user_setpoint, cur_pos, wait=True)
        #     yield from abs_set(zps.pi_r.motor_calib, 0, wait=True)
        # yield from abs_set(zps.pi_r.acceleration, 1, wait=True)
        # yield from abs_set(zps.pi_r.velocity, 30, wait=True)
        # yield from abs_set(zps.pi_r.user_setpoint, ini_r, wait=True)
        cur_pos = zps.pi_r.position
    ...
    def set_cam_step_for_scan(det, scn_cfg):
        ...
        # yield from abs_set(det.cam.acquire, 1, wait=True)
        FXITomoFlyer.set_wait(det.cam.acquire_time, scn_cfg["exp_t"])
        FXITomoFlyer.set_wait(det.cam.acquire_period, scn_cfg["acq_p"])
    ...
    def set_mot_r_step_for_scan(scn_cfg):
        ...
        # yield from abs_set(zps.pi_r.user_setpoint, scn_cfg["ang_s"], wait=True)
        FXITomoFlyer.set_wait(zps.pi_r.acceleration, scn_cfg["tacc"])
        FXITomoFlyer.set_wait(zps.pi_r.velocity, scn_cfg["vel"])
        FXITomoFlyer.set_wait(zps.pi_r.user_setpoint, scn_cfg["ang_s"] - scn_cfg["rot_dir"] * scn_cfg["taxi_dist"])

    @staticmethod
    def set_cam_mode(cam, stage="pre-scan"):
        if stage == "pre-scan":
            yield from abs_set(cam.cam.image_mode, 0)
            yield from abs_set(cam.cam.trigger_mode, 4)
        elif stage == "ref-scan":
            yield from abs_set(cam.cam.image_mode, 0)
            yield from abs_set(cam.cam.trigger_mode, 0)
        elif stage == "post-scan":
            yield from abs_set(cam.cam.image_mode, 1)
            yield from abs_set(cam.cam.trigger_mode, 0)
