...
motor_optics = [cm.x, cm.yaw, cm.y, cm.p, cm.r, cm.xu, cm.xd, cm.yu, cm.ydi, cm.ydo,
                tm.x, tm.yaw, tm.y, tm.p, tm.r, tm.xu, tm.xd, tm.yu, tm.ydi, tm.ydo,
                dcm.th1, dcm.dy2, dcm.th2, dcm.chi2, dcm.eng,
                pbsl.x_gap, pbsl.y_gap, pbsl.x_ctr, pbsl.y_ctr,
