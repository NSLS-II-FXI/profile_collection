...
def test_tomo_zfly_scan():
    ...
    uid, = RE(tomo_zfly(scn_mode=0, exp_t=0.05, acq_p=0.052, ang_s=0, ang_e=180, vel=3, acc_t=1, num_swing=1, out_pos=[None, -200, None, None], rel_out_flag=True, rot_back_velo=30, bin_fac=1, roi={"min_x": 576, "size_x": 2048, "min_y": 576, "size_y": 2048}, note="test", simu=True))
